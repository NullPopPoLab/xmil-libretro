...
void update_input(void)
{
	...
	int i;
  	...
  	joymng_sync();
		...
		if (input_state_cb(0, RETRO_DEVICE_JOYPAD,0, RETRO_DEVICE_ID_JOYPAD_SELECT)) Core_Key_State[RETROK_PAGEUP] = 0x80;
		if (input_state_cb(0, RETRO_DEVICE_JOYPAD,0, RETRO_DEVICE_ID_JOYPAD_START)) Core_Key_State[RETROK_PAGEDOWN] = 0x80;
		...
		if (input_state_cb(0, RETRO_DEVICE_JOYPAD,0, RETRO_DEVICE_ID_JOYPAD_MODE)) Core_Key_State[RETROK_LCTRL] = 0x80;
