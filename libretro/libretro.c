...
void update_input(void)
{
	...
	int i;
  	...
  	joymng_sync();
		...
		if (input_state_cb(0, RETRO_DEVICE_JOYPAD,0, RETRO_DEVICE_ID_JOYPAD_MODE)) Core_Key_Sate[RETROK_LCTRL] = 0x80;
		if (input_state_cb(0, RETRO_DEVICE_JOYPAD,0, RETRO_DEVICE_ID_JOYPAD_LEFT_ANALOG_RIGHT)) Core_Key_Sate[RETROK_RIGHT] = 0x80;
		if (input_state_cb(0, RETRO_DEVICE_JOYPAD,0, RETRO_DEVICE_ID_JOYPAD_LEFT_ANALOG_LEFT)) Core_Key_Sate[RETROK_LEFT] = 0x80;
		if (input_state_cb(0, RETRO_DEVICE_JOYPAD,0, RETRO_DEVICE_ID_JOYPAD_LEFT_ANALOG_DOWN)) Core_Key_Sate[RETROK_DOWN] = 0x80;
		if (input_state_cb(0, RETRO_DEVICE_JOYPAD,0, RETRO_DEVICE_ID_JOYPAD_LEFT_ANALOG_UP)) Core_Key_Sate[RETROK_UP] = 0x80;
		if (input_state_cb(0, RETRO_DEVICE_JOYPAD,0, RETRO_DEVICE_ID_JOYPAD_RIGHT_ANALOG_RIGHT)) Core_Key_Sate[RETROK_KP6] = 0x80;
		if (input_state_cb(0, RETRO_DEVICE_JOYPAD,0, RETRO_DEVICE_ID_JOYPAD_RIGHT_ANALOG_LEFT)) Core_Key_Sate[RETROK_KP4] = 0x80;
		if (input_state_cb(0, RETRO_DEVICE_JOYPAD,0, RETRO_DEVICE_ID_JOYPAD_RIGHT_ANALOG_DOWN)) Core_Key_Sate[RETROK_KP2] = 0x80;
		if (input_state_cb(0, RETRO_DEVICE_JOYPAD,0, RETRO_DEVICE_ID_JOYPAD_RIGHT_ANALOG_UP)) Core_Key_Sate[RETROK_KP8] = 0x80;
